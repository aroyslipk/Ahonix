    ...
    <div className="min-h-screen bg-[#08090E] text-[#F8FAFC]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 sm:py-16">
        ...
        <div className="mb-12 border-b border-[#1E2235] pb-8">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/10 px-3.5 py-1 text-xs font-medium text-cyan-400">
          ...
          <p className="mt-4 text-base leading-relaxed text-[#CBD5E1]">
            These Terms of Service ("Terms") constitute a legally binding agreement between you ("Merchant", "User", or "you")
            and AHONIX ("AHONIX", "we", "our", or "us") governing your access to and use of our commerce intelligence platform,
            web applications, and integration services.
          </p>
        </div>

        {/* Important Financial Disclaimer Callout */}
        <div className="mb-10 rounded-2xl border border-amber-500/30 bg-amber-950/20 p-5 sm:p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-base font-bold text-amber-300">
                Important Disclaimer: Analytical Calculations, Not Certified Accounting
              </h2>
              <p className="mt-1.5 text-sm leading-relaxed text-[#CBD5E1]">
                AHONIX computes financial estimates (including True Profit, COGS resolutions, Blended ROAS, and Blended CAC)
                for business decision support based strictly on your connected data and configured inputs. AHONIX does <strong className="text-amber-200">not</strong> provide
                certified public accounting (CPA), statutory tax, auditing, or legal advice. You remain solely responsible for
                statutory financial disclosures, tax filings, and business decisions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-12 text-[#CBD5E1]">
          ...
          <section id="service-description" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">1.</span> Description of the Service
            </h2>
            <p className="text-sm leading-relaxed">
              AHONIX is an AI Commerce Operating System designed for direct-to-consumer (DTC) brands and online retailers.
              The service provides:
            </p>
            <ul className="space-y-1.5 text-sm text-[#94A3B8]">
              <li>• Multi-channel sales and catalog ingestion from Shopify stores</li>
              <li>• Advertising campaign performance and spend ingestion from Meta Ads and Google Ads</li>
              <li>• Cost of Goods Sold (COGS) tracking and variant-level unit margin configuration</li>
          ...
          <section id="eligibility-accounts" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">2.</span> Eligibility & Account Responsibilities
            </h2>
            <p className="text-sm leading-relaxed">
          ...
          <section id="merchant-authorization" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">3.</span> Merchant Authorization & Third-Party Integrations
            </h2>
            <p className="text-sm leading-relaxed">
              By connecting your Shopify store, Meta Ads account, or Google Ads account to AHONIX:
            </p>
            <div className="space-y-3 rounded-xl border border-[#1E2235] bg-[#0F111A] p-5 text-sm text-[#94A3B8]">
              <p>
          ...
          <section id="acceptable-use" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">4.</span> Acceptable Use
            </h2>
            <p className="text-sm leading-relaxed">
          ...
          <section id="financial-disclaimer" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">5.</span> Financial Analytics & AI Recommendation Disclaimers
            </h2>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-[#1E2235] bg-[#0F111A] p-5">
                <div className="flex items-center gap-2 text-sm font-bold text-[#F8FAFC]">
                  <TrendingUp size={16} className="text-emerald-400" /> True Profit & ROAS Analytics
                </div>
              ...
              <div className="rounded-xl border border-[#1E2235] bg-[#0F111A] p-5">
                <div className="flex items-center gap-2 text-sm font-bold text-[#F8FAFC]">
                  <BrainCircuit size={16} className="text-cyan-400" /> AI Insights & Simulations
                </div>
                <p className="mt-2 text-xs text-[#94A3B8] leading-relaxed">
          ...
          <section id="data-ownership" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">6.</span> Data Ownership & Intellectual Property
            </h2>
            <p className="text-sm leading-relaxed">
          ...
          <section id="disconnection-termination" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">7.</span> Disconnection, Cancellation & Termination
            </h2>
            <p className="text-sm leading-relaxed">
          ...
          <section id="limitation-of-liability" className="space-y-3">
            ...
            <div className="rounded-xl border border-[#1E2235] bg-[#0F111A] p-5 text-xs text-[#94A3B8] leading-relaxed space-y-2">
              <p>
          ...
          <section id="changes-governing" className="space-y-3">
            <h2 className="font-display text-xl font-bold text-[#F8FAFC] flex items-center gap-2">
              <span className="text-emerald-400">9.</span> Changes to Terms & Contact Information
            </h2>
            <p className="text-sm leading-relaxed">
            ...
            <div className="mt-4 flex flex-col gap-3 rounded-xl border border-[#1E2235] bg-[#0F111A] p-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-cyan-500/10 px-4 py-2 text-xs font-semibold text-cyan-400 hover:bg-cyan-500/20"
              >
